...
export default function Dropdown({ btn }) {
  return (
    <div className="w-100 row m-0">
      <button className="btn btn-sm w-100 ps-4 pe-0 d-flex align-items-center btn-sidebar text-hover-light collapsed right-rotate"
        data-bs-toggle="collapse" data-bs-target={`#collapse-area-${btn.label}`}
        aria-expanded="false" aria-controls={`collapse-area-${btn.label}`}>
